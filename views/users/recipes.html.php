  ...
  <div class="midarea">
    ...
    <div class="body_textarea">
      <!--用户的头像-->
	    ...
	    <div class="body_textarea">
     <font size="3" color="#DCDCDC" background= "#A9A9A9">My recipes</font>
    </div>
...
if (count($template->myrecipes)!=0)
{
	...
	{
		echo "<br />";
		echo "Recipe Name: " . $myrecipe->recipe_name . "<br />";
		echo "Preparation Time: " . $myrecipe->preparation_time . "<br />";
		echo "Cooking Time: " . $myrecipe->cooking_time . "<br />";
		echo "Number of Servings: " . $myrecipe->number_of_servings . "<br />";
		echo "Image Name: " . $myrecipe->image_name . "<br />";
		echo "Image is cover: " . $myrecipe->is_cover . "<br />";
		echo "<a href='/myrecipe/recipes/" . $myrecipe->recipe_id . "/edit'>Edit</a>";
		echo "<br />";
		echo "<a href='/myrecipe/recipes/" . $myrecipe->recipe_id . "/addpic'>Add Pic</a>";
		echo "<br />";
	}
}
else
